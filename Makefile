...
DEPLOYDIR=/Users/james/Dropbox/Development/go/src/Gateway311/_deploy
...
linuxcompile:
	env GOOS=linux GOARCH=amd64 go build -o $(DEPLOYDIR)/gateway/gateway               Gateway311/engine
